...
def retrieveAverage(username):
    ...
    if choice == "Yes":
        ...
        if result:
            ...
            upload_average(username, oven, oven_type, bulb_type, rooms, hours_lit, fridge_size, heating_hours, number_phones, pc_hours, tv_hours, washer_hours, dryer_hours, dishwasher_hours, games_console_hours, kettle_uses, other_hours, total_daily_emissions)
